...
main(int argc, char **argv)
{
	...
	retval = ioctl(fd_fb1, FBIOGET_FSCREENINFO, &fb_fix);
        ...
        printf("fb0 Screen size=%d, xres=%d yres=%d, xres_virtual=%d yres_virtual=%d, bpp=%d\n", 
                g_fb0_size, screen_info.xres, screen_info.yres,
        ...
        printf("fb1 Screen size=%d, xres=%d yres=%d, xres_virtual=%d yres_virtual=%d, bpp=%d\n", 
                g_fb1_size, screen_info.xres, screen_info.yres,
                screen_info.xres_virtual, screen_info.yres_virtual, screen_info.bits_per_pixel);
