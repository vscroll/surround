...
public:
    virtual ~ICapture() {}
    virtual int setCapCapacity(struct cap_sink_t sink[], struct cap_src_t source[], unsigned int channelNum) = 0;
    virtual int setFocusSource(unsigned int focusChannelIndex, struct cap_src_t* focusSource) = 0;
