...
__kernel void stitch_2d_render	(__global uchar* image_front,
                        __global uchar* image_rear,
                        __global uchar* image_left,
                        __global uchar* image_right,
                        int side_width,
                        ...
                        __global uchar* pano)
{
    ...
    // copy the input to output
    int id = row*pano_width*2+col;
    pano[id] = image_front[row*side_width*2+col];
    ...
    // copy the input to output
    int id = row*424*2+col;
    int id_pano = row*pano_width*2+col;
    int flag = mask[id];
    switch (flag)
    {
    case 0:
        {
            ...
            int index1 = lut_front[id];
            int index2 = lut_left[id];
            pano[id_pano] = w*image_front[index1] + (1- w)*image_left[index2];
            break;
        }
    case 1:
        {
            int index1 = lut_front[id];
            pano[id_pano] = image_front[index1];
            break;
        }
    case 2:
        {
            ...
            int index1 = lut_front[id];
            int index2 = lut_right[id];
            pano[id_pano] = w*image_front[index1] + (1 - w)*image_right[index2];
            break;
        }
    case 3:
        {
            int index1 = lut_left[id];
            pano[id_pano] = image_left[index1];
            break;
        }
    case 4:
        {
    ...
    case 5:
        {
            int index1 = lut_right[id];
            pano[id_pano] = image_right[index1];
            break;
        }
    case 6:
        {
            ...
            int index1 = lut_rear[id];
            int index2 = lut_left[id];
            pano[id_pano] = w*image_rear[index1] + (1 - w)*image_left[index2];
            break;
        }
    case 7:
        {
            int index1 = lut_rear[id];
            pano[id_pano] = image_rear[index1];
            break;
        }
    case 8:
        {
            ...
            size_t index1 = lut_rear[id];
            size_t index2 = lut_right[id];
            pano[id_pano] = w*image_rear[index1] + (1 - w)*image_right[index2];
            break;
        }
    default:
        break;
