...
const int yuyv_tex_width = image_width/2;
        ...
        switch (select_num)
        {
            case 1:
            {
                ...
                if (index < image_size)
                {
                    ...
                    yuv_front.x = 1.1643 * (texture(s_front, texCoord).r - 0.0625);
                    yuv_front.y = texture(s_front, texCoord).a - 0.5;
                    yuv_front.z = texture(s_front, texCoord).g - 0.5;
            ...
            case 2:
            {
                ...
                if (index1 < image_size && index2 < image_size)
                {
                    ...
                    yuv_front.x = 1.1643 * (texture(s_front, texCoord1).r - 0.0625);
                    yuv_front.y = texture(s_front, texCoord1).a - 0.5;
                    yuv_front.z = texture(s_front, texCoord1).g - 0.5;

                    vec2 texCoord2 = lutIndex2TextureCoord(index2);
                    yuv_right.x = 1.1643 * (texture(s_right, texCoord2).r - 0.0625);
                    yuv_right.y = texture(s_right, texCoord2).a - 0.5;
                    yuv_right.z = texture(s_right, texCoord2).g - 0.5;
            ...
            case 3:
            {
                ...
                {
                    vec2 texCoord = lutIndex2TextureCoord(index);
                    yuv_right.x = 1.1643 * (texture(s_right, texCoord).r - 0.0625);
                    yuv_right.y = texture(s_right, texCoord).a - 0.5;
                    yuv_right.z = texture(s_right, texCoord).g - 0.5;
            ...
            case 4:
            {
                ...
                {
                    vec2 texCoord1 = lutIndex2TextureCoord(index1);
                    yuv_rear.x = 1.1643 * (texture(s_rear, texCoord1).r - 0.0625);
                    yuv_rear.y = texture(s_rear, texCoord1).a - 0.5;
                    yuv_rear.z = texture(s_rear, texCoord1).g - 0.5;
            ...
            case 5:
            {
                ...
                {
                    vec2 texCoord = lutIndex2TextureCoord(index);
                    yuv_rear.x = 1.1643 * (texture(s_rear, texCoord).r - 0.0625);
                    yuv_rear.y = texture(s_rear, texCoord).a - 0.5;
                    yuv_rear.z = texture(s_rear, texCoord).g - 0.5;
            ...
            case 6:
            {
                ...
                if (index1 < image_size && index2 < image_size)
                {
                    ...
                    vec2 texCoord2 = lutIndex2TextureCoord(index2);
                    yuv_left.x = 1.1643 * (texture(s_left, texCoord2).r - 0.0625);
                    yuv_left.y = texture(s_left, texCoord2).a - 0.5;
                    yuv_left.z = texture(s_left, texCoord2).g - 0.5;
            ...
            case 7:
            {
                ...
                {
                    vec2 texCoord = lutIndex2TextureCoord(index);
                    yuv_left.x = 1.1643 * (texture(s_left, texCoord).r - 0.0625);
                    yuv_left.y = texture(s_left, texCoord).a - 0.5;
                    yuv_left.z = texture(s_left, texCoord).g - 0.5;
