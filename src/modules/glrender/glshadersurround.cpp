...
#include "modelsurround.vert"
#include "modelsurround.frag"
...
GLShaderSurround::GLShaderSurround(ESContext* context)
:GLShader(context)
{
    mLastCallTime = 0;
}

GLShaderSurround::~GLShaderSurround()
{

}

const char* GLShaderSurround::getVertShader()
{
    return gVShaderStr;
}

const char* GLShaderSurround::getFragShader()
{
    return gFShaderStr;
}

int GLShaderSurround::initConfig()
{
    return 0;
}

void GLShaderSurround::initVertex()
{
...
void GLShaderSurround::initTexture()
{
...
void GLShaderSurround::draw()
{
    drawOnce();
}

void GLShaderSurround::drawOnce()
{
...
void GLShaderSurround::glUpdate ()
{
   ...
   esTranslate( &mUserData.modelMatrix, 0.0, 2.0, -2.0 );
...
void GLShaderSurround::shutdown()
{
...
GLboolean GLShaderSurround::loadTexture(GLuint textureId, unsigned char *buffer, int width, int height)
{
